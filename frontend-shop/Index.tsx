    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative overflow-hidden border-b border-border bg-card">
        ...
        <div className="container relative mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <div>
            <h1 className="text-xl font-bold">Retail & Warehouse System</h1>
          </div>
        ...
        <div className="container relative mx-auto px-4 pt-8 pb-16 text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-sm text-muted-foreground">
            <div className="flex items-center gap-2 rounded-full border border-border bg-secondary/50 px-4 py-2">
              ...
              Network: 26.242.135.113 • API Server: 26.242.135.113
            </div>
          </div>
        </div>
      </div>
